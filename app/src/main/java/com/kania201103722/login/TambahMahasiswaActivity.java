...
public class TambahMahasiswaActivity extends AppCompatActivity {
    ...
    private EditText _alamatEditText, _namaEditText, _nimEditText, _tahunMasukEditText, _tanggalLahieEditText;
    ...
    private void initSaveButton() {
        ...
        _savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view){
                ...
                String tanggalLahir = _tanggalLahieEditText.getText().toString();
                ...
                ahc.get(url, new AsyncHttpResponseHandler() {
                    ...
                    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                        Toast.makeText(TambahMahasiswaActivity.this, "", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    _tanggalLahieEditText = findViewById(R.id.tanggalLahirEditText);
